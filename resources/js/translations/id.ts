export const id = {
    ...
    // Auth
    'auth.login_title': 'Masuk ke akun Anda',
    'auth.login_description': 'Masukkan email dan password Anda untuk masuk',
    'auth.register_title': 'Buat akun',
    'auth.register_description': 'Masukkan detail Anda untuk membuat akun',
    'auth.email': 'Alamat Email',
    'auth.password': 'Password',
    'auth.password_confirmation': 'Konfirmasi Password',
    'auth.name': 'Nama',
    'auth.remember_me': 'Ingat saya',
    'auth.forgot_password': 'Lupa password?',
    'auth.login_button': 'Masuk',
    'auth.register_button': 'Buat akun',
    ...
    'auth.forgot_password_description': 'Masukkan email Anda untuk menerima link reset password',
    'auth.email_reset_link': 'Kirim link reset password',
    'auth.return_to_login': 'Atau, kembali ke',
    'auth.reset_password_title': 'Reset password',
    'auth.reset_password_description': 'Silakan masukkan password baru Anda',
